...
export class NavBarProfileComponent implements OnInit {
  ...
  constructor(private authService: AuthenticationService, private companyService: CompanyService, private impresionService: ImpresionsService, private usetService: UserService) { }
  ...
  addToken() {
    this.usetService.addPromotionToken(this.token).subscribe(res => {
      Swal.fire("success", "Your promotion token is added");
    },
      err => {
        Swal.fire("opssss...", "Something went wrong")
      })
